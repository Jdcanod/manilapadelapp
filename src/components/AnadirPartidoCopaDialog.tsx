...
export function AnadirPartidoCopaDialog({ torneoId, clubLocal, clubRival, categoriasSugeridas = [] }: Props) {
    ...
    const [puntos, setPuntos] = useState<1 | 3>(3);
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            const r = await crearPartidoCopa({
                torneoId,
            ...
            if (!r.success) {
                setError(r.message || "Error al crear partido");
                return;
            }
            setOpen(false);
            reset();
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            >
                                ...
                                <span className="block text-[9px] uppercase tracking-widest mt-1">Punto</span>
                            </button>
                            <button
                                type="button"
                                onClick={() => setPuntos(3)}
                            ...
                            >
                                ...
                                <span className="block text-[9px] uppercase tracking-widest mt-1">Puntos</span>
                            </button>
                        </div>
                    </div>
